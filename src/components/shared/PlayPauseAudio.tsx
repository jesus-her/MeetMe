...
export default class PlayPauseAudio extends React.Component<Props, State> {
  ...
  componentDidMount() {
    (async () => {
      await Font.loadAsync({
        "cutive-mono-regular": require("../../../assets/fonts/Nunito/Nunito-Black.ttf"),
      });
          ...
          >
            <View style={styles.volumeContainer}>
              ...
              >
                <Image
                  ...
                  source={this.state.muted ? icons.muted : icons.unmute}
                />
              </TouchableHighlight>
              <Slider
            ...
            <View style={styles.playStopContainer}>
              ...
              >
                <IconLabel
                  icon={
                    this.state.isPlaying ? icons.pause_audio : icons.play_audio
                  }
                  /*label={"Play"}*/
                  containerStyle={{
                    marginLeft: 0,
