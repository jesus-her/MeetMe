...
import { useAudioHelper } from "../helpers/audio-help";
    ...
    listSounds: [
      {
        ...
        name: "1 Tropic - Anno Domini Beats",
      },
      {
        type: "network",
        path: "https://raw.githubusercontent.com/uit2712/RNPlaySound/develop/sounds/Tropic%20-%20Anno%20Domini%20Beats.mp3",
        name: "2 Tropic - Anno Domini Beats",
      },
      {
        type: "network",
        path: "https://raw.githubusercontent.com/uit2712/RNPlaySound/develop/sounds/Tropic%20-%20Anno%20Domini%20Beats.mp3",
        name: "3 Tropic - Anno Domini Beats",
      },
      {
        type: "network",
        path: "https://raw.githubusercontent.com/uit2712/RNPlaySound/develop/sounds/Tropic%20-%20Anno%20Domini%20Beats.mp3",
        name: "4 Tropic - Anno Domini Beats",
      },
    ],
    timeRate: 15,
    isLogStatus: true,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.changeAudio}>
        ...
        <Image
          source={require("../../assets/images/chuy.jpg")}
          style={styles.avatar}
        />
